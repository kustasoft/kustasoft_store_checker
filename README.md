...
dependencies:
  kustasoft_store_checker: ^1.0.0

```dart
import 'package:kustasoft_store_checker/kustasoft_store_checker.dart';

Source installationSource = await KustaSoftStoreChecker.getSource;
...
Please file [issues](https://github.com/kustasoft/kustasoft_web_browser/issues) to send feedback or report a bug. Thank you!